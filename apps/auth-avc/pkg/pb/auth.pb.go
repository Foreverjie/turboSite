...
func (x *RequestError) GetStatus() int64 {
	if x != nil {
		return x.Status
	}
	return 0
...
func (x *RequestError) GetError() string {
	if x != nil {
		return x.Error
	}
	return ""
...
var file_pkg_pb_auth_proto_rawDesc = []byte{
	...
	0x28, 0x03, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x22, 0x3c, 0x0a, 0x0c, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x74,
	...
	0x09, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x32, 0xbb, 0x01, 0x0a, 0x0b, 0x41, 0x75, 0x74,
...
var file_pkg_pb_auth_proto_goTypes = []interface{}{
	...
	(*RequestError)(nil),     // 6: auth.RequestError
}
